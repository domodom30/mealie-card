  ...
  protected render() {
    ...
    return html`
      <div class="card-config">
        <div class="option">
          <ha-textfield label="${localize('editor.title')}" .value=${titleValue} .configValue=${'title'} placeholder="${localize('common.recipe_title')}" @input=${this.valueChanged} helper-text="${localize('editor.title_helper')}"></ha-textfield>
        </div>
