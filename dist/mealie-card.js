...
`,Fi=(e,t,i,a)=>{const s={},n=new Event(t,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed});return n.detail=i,e.dispatchEvent(n),n},qi={shopping_list:"add_recipe_to_shopping_list",interactive_rating:"rate_recipe",favorites:"add_recipe_favorite",import_recipe:"import_recipe",random_mealplan:"set_random_mealplan",edit_mealplan:"update_mealplan",delete_mealplan:"delete_mealplan"};function Hi(e,t){return!!e?.services?.[fe]?.[qi[t]]}function Wi(e){if(!e)return!1;try{const{protocol:t}=new URL(e);return"http:"===t||"https:"===t}catch{return!1}}function Ki(e){window.open(e,"_blank","noopener,noreferrer")}const Gi={tiny:"tiny-original.webp",min:"min-original.webp",original:"original.webp"};const Zi=e=>class extends e{constructor(){super(...arguments),this.localize=(e,t,i)=>li(this.hass?.locale?.language??"en",e,t,i),this.localizeError=(e,t="error.error_loading")=>{if(e instanceof vi){const t=this.localize(e.translationKey);return e.detail?`${t}: ${e.detail}`:t}return e instanceof Error&&e.message?e.message:this.localize(t)}}},Qi=()=>{},Ji=e=>customElements.get(e)?Qi:(e=>(t,i)=>{void 0!==i?i.addInitializer(()=>{customElements.define(e,t)}):customElements.define(e,t)})(e);var Yi=Object.defineProperty,Xi=Object.getOwnPropertyDescriptor,ea=(e,t,i,a)=>{for(var s,n=a>1?void 0:a?Xi(t,i):t,r=e.length-1;r>=0;r--)(s=e[r])&&(n=(a?s(t,i,n):s(n))||n);return a&&n&&Yi(t,i,n),n};let ta=class extends re{constructor(){super(...arguments),this.rating=0,this.interactive=!1,this.updating=!1,this._hovered=0}_emit(e){this.updating||this.dispatchEvent(new CustomEvent("rate-selected",{detail:{rating:e},bubbles:!1,composed:!1}))}render(){return this.interactive?this._renderInteractive():this._renderReadonly()}_renderReadonly(){const e=this.rating;return B`
  ...
  `,ta.STARS=[1,2,3,4,5],ea([ce({type:Number})],ta.prototype,"rating",2),ea([ce({type:Boolean})],ta.prototype,"interactive",2),ea([ce({type:Boolean})],ta.prototype,"updating",2),ea([pe()],ta.prototype,"_hovered",2),ta=ea([Ji("mealie-star-rating")],ta);var ia=Object.defineProperty,aa=(e,t,i,a)=>{for(var s,n=void 0,r=e.length-1;r>=0;r--)(s=e[r])&&(n=s(t,i,n)||n);return n&&ia(t,i,n),n};function sa(e){e.currentTarget.parentElement?.classList.remove("image-loading")}function na(e){const t=e.currentTarget.parentElement;t&&(t.classList.remove("image-loading"),t.classList.add("image-error"))}function ra(e,t,i){const a=function(e,t,i="min"){if(e.image&&((a=e.image).startsWith("/")&&!a.startsWith("//")||a.startsWith("http")))return e.image;var a;if(!t)return null;const s=t.replace(/\/$/,""),n=e.recipe_id||e.slug;return n?`${s}/api/media/recipes/${encodeURIComponent(n)}/images/${Gi[i]}`:null}(t,i.url,i.variant??"min");if(!a)return q;const s=function(e,t){return t.startsWith("/")?`${e.auth.data.hassUrl}${t}`:t}(e,a);if(!function(e){if(e.startsWith("//"))return!1;if(e.startsWith("/"))return!0;try{const{protocol:t}=new URL(e);return"http:"===t||"https:"===t}catch{return!1}}(s))return q;const n=function(e){return!e.image}(t)&&i.onImageMissing?i.onImageMissing:na;return B`
  ...
  `}const oa=e=>{class t extends(Zi(e)){constructor(){super(...arguments),this.error=null,this._loading=!1,this._initialized=!1,this._ratings=new Map,this._updatingRatings=new Set,this._favorites=new Map,this._updatingFavorites=new Set,this._missingImages=new Set}supports(e){return Hi(this.hass,e)}get baseConfig(){return this.config??{}}recipeWebUrl(e){return function(e,t,i){if(!Wi(e)||!t)return null;const a=e.replace(/\/$/,""),s=i?.trim()||be;return`${a}/g/${encodeURIComponent(s)}/r/${encodeURIComponent(t)}`}(this.baseConfig.url,e?.slug,this.baseConfig.mealie_group_slug)}openRecipe(e){if("browser"!==this.baseConfig.recipe_view)return!0;const t=this.recipeWebUrl(e);return!t||(Ki(t),!1)}handleError(e){this.error=this.localizeError(e)}_markImageMissing(e){this._missingImages.has(e)||(this._missingImages=new Set(this._missingImages).add(e))}renderRecipeImage(e,t,i=q){if(!t)return q;const a=e.slug??e.recipe_id;return a&&this._missingImages.has(a)?q:ra(this.hass,e,{url:this.baseConfig.url,variant:"min",containerClass:"recipe-card-image",imgClass:"recipe-image",onImageMissing:a?()=>this._markImageMissing(a):void 0,overlay:i})}renderIconButton(e){return B`
      ...
      `}renderCardButtons(e){return B`<div class="card-buttons">${e.map(e=>this.renderIconButton(e))}</div>`}renderRecipeMedia(e,t,i){const a=i.length?this.renderCardButtons(i):q,s=this.renderRecipeImage(e,t,a);return s!==q?s:a}renderRecipeName(e){return B`<h4 class="recipe-name">${e.name??e.title}</h4>`}renderRecipeDescription(e,t){return t&&e?B`<div class="recipe-description">${e}</div>`:q}buildTimeRows(e,t=!0,i=!0,a=!0){const s=this.hass?.locale?.language;return[t&&e.prep_time?{icon:"mdi:knife",label:this.localize("dialog.prep_time"),value:ui(e.prep_time,s)}:null,i&&e.perform_time?{icon:"mdi:pot-steam",label:this.localize("dialog.cooking_time"),value:ui(e.perform_time,s)}:null,a&&e.total_time?{icon:"mdi:clock-time-three-outline",label:this.localize("dialog.total_time"),value:ui(e.total_time,s)}:null].filter(Boolean)}renderTimeRows(e){return B`${e.map(e=>B`
        ...
        `)}`}renderRecipeTimes(e,t,i,a){const s=this.buildTimeRows(e,t,i,a);return s.length?B`<div class="recipe-times">${this.renderTimeRows(s)}</div>`:q}async _setRating(e,t,i){if(!e||!this.hass)return;if(this._updatingRatings.has(e))return;const a=this._ratings.get(e)??0;this._ratings=new Map(this._ratings).set(e,t),this._updatingRatings=new Set(this._updatingRatings).add(e);try{await function(e,t,i,a){return bi("error.error_loading",()=>{if(!t)throw new vi("error.error_loading");return $i(e,"rate_recipe",{recipe_slug:t,rating:i},a)})}(this.hass,e,t,i),Ui(Pi,{slug:e,rating:t})}catch{this._ratings=new Map(this._ratings).set(e,a),Fi(this,"hass-notification",{message:this.localize("error.error_loading")})}finally{const t=new Set(this._updatingRatings);t.delete(e),this._updatingRatings=t}}async _toggleFavorite(e,t){if(!e||!this.hass)return;if(this._updatingFavorites.has(e))return;const i=this._favorites.get(e)??!1,a=!i;this._favorites=new Map(this._favorites).set(e,a),this._updatingFavorites=new Set(this._updatingFavorites).add(e),Ui(Oi,{slug:e,favorite:a});try{await(a?function(e,t,i){return bi("error.error_loading",()=>{if(!t)throw new vi("error.error_loading");return $i(e,"add_recipe_favorite",{recipe_slug:t},i)})}(this.hass,e,t??void 0):function(e,t,i){return bi("error.error_loading",()=>{if(!t)throw new vi("error.error_loading");return $i(e,"remove_recipe_favorite",{recipe_slug:t},i)})}(this.hass,e,t??void 0))}catch{this._favorites=new Map(this._favorites).set(e,i),Ui(Oi,{slug:e,favorite:i}),Fi(this,"hass-notification",{message:this.localize("error.error_loading")})}finally{const t=new Set(this._updatingFavorites);t.delete(e),this._updatingFavorites=t}}renderFavoriteButton(e,t,i){if(!t||!this.supports("favorites"))return q;const a=e?.slug;if(!a)return q;const s=this._favorites.get(a)??!1;return B`
        <ha-icon-button
  ...
  `}function pa(e,t,i,a){return B`
    ...
    ></ha-selector>
  `}da.styles=Bi,((e,t,i)=>{for(var a,s=void 0,n=e.length-1;n>=0;n--)(a=e[n])&&(s=a(t,i,s)||s);s&&la(t,i,s)})([ce({attribute:!1})],da.prototype,"hass");const ha=n`
...
`,_a="3.0.6";var ua=Object.defineProperty,ga=(e,t,i,a)=>{for(var s,n=void 0,r=e.length-1;r>=0;r--)(s=e[r])&&(n=s(t,i,n)||n);return n&&ua(t,i,n),n};const ma=new Map;class fa extends(Zi(re)){constructor(){super(...arguments),this._imageIsHash=void 0,this._imageCheckEntry="__unset__",this._computeLabel=e=>({config_entry_id:this.localize("editor.integration")}[e.name]??e.name)}setConfig(e){this.config={...e}}updated(e){if(super.updated(e),!this.hass||!this.config)return;const t=this.config.config_entry_id??null;t!==this._imageCheckEntry&&(this._imageCheckEntry=t,this._imageIsHash=void 0,t&&this._refreshImageFormat(t))}async _refreshImageFormat(e){const t=await async function(e,t){const i=ma.get(t);if(void 0!==i)return i;let a;try{a=await Ei(e,{configEntryId:t,resultLimit:1})}catch{return!0}const s=a[0]?.image,n=!s||!(s.startsWith("/")||s.startsWith("http"));return ma.set(t,n),n}(this.hass,e);this._imageCheckEntry===e&&(this._imageIsHash=t)}get _needsMealieUrl(){return!!this._imageIsHash||"dialog"!==this.config.recipe_view}get _showImageAllowed(){return!!this.config?.config_entry_id&&(void 0!==this._imageIsHash&&(!this._imageIsHash||Wi(this.config.url)))}get _schemaTop(){return[{type:"expandable",title:this.localize("editor.integration"),icon:"mdi:connection",schema:[{name:"config_entry_id",selector:{config_entry:{integration:"mealie"}}}]}]}_setValue(e,t){this.config={...this.config,[e]:t},Fi(this,"config-changed",{config:this.config})}_valueChanged(e){const t={...e.detail.value};t.config_entry_id||(t.show_image=!1),this.config=t,Fi(this,"config-changed",{config:this.config})}renderEditorLoading(){return B`<div>${this.localize("editor.loading")}</div>`}renderTopForm(){return B`
      <ha-form
        .hass=${this.hass}
        .data=${this.config}
    ...
    `}render(){return this.hass&&this.config?B`
      ...
      <ha-form
        .hass=${this.hass}
        .data=${{...this.config,day_offset:ya(this.config.day_offset,this.config.days_to_show),days_columns:String(this.config.days_columns??2),recipes_columns:String(this.config.recipes_columns??2),layout_mode:this._layoutMode()}}
      ...
      ></ha-form>
      ${this.renderVersion()}
    `:this.renderEditorLoading()}_layoutMode(){const e="horizontal"===this.config.days_layout,t="horizontal"===this.config.recipes_layout;return e?t?"both":"side_by_side":t?"horizontal":"vertical"}};ba=((e,t,i,a)=>{for(var s,n=a>1?void 0:a?va(t,i):t,r=e.length-1;r>=0;r--)(s=e[r])&&(n=s(n)||n);return n})([Ji("mealie-card-editor")],ba);var wa=Object.defineProperty,$a=(e,t,i,a)=>{for(var s,n=void 0,r=e.length-1;r>=0;r--)(s=e[r])&&(n=s(t,i,n)||n);return n&&wa(t,i,n),n};class za extends(Zi(re)){constructor(){super(...arguments),this.configEntryId=null,this.open=!1,this._submitting=!1,this._close=()=>{this.open=!1,this.dispatchEvent(new CustomEvent("dialog-closed",{bubbles:!1,composed:!1}))}}onOpen(){}updated(e){super.updated(e),e.has("open")&&this.open&&(this._submitting=!1,this.onOpen())}async submit(e){if(!this._submitting){this._submitting=!0;try{await e.run(),Fi(this,"hass-notification",{message:"function"==typeof e.success?e.success():this.localize(e.success)}),e.signal&&(t=e.signal,Ni[t]+=1,window.dispatchEvent(new CustomEvent(t))),!1!==e.closeOnSuccess&&this._close()}catch(t){Fi(this,"hass-notification",{message:this.localizeError(t,e.errorKey)})}finally{this._submitting=!1}var t}}renderDateSelector(e,t){return B`
      <ha-selector
        .hass=${this.hass}
        .selector=${{date:{}}}
        .value=${e}
    ...
    `:q}render(){return this.open&&this.recipe?B`
      ...
      ></mealie-shopping-list-dialog>
    `:q}};Sa([ce({attribute:!1})],Ra.prototype,"config",2),Sa([ce({attribute:!1})],Ra.prototype,"recipe",2),Sa([ce({attribute:!1})],Ra.prototype,"isFavorite",2),Sa([ce()],Ra.prototype,"defaultShoppingListId",2),Sa([pe()],Ra.prototype,"_detail",2),Sa([pe()],Ra.prototype,"_servings",2),Sa([pe()],Ra.prototype,"_shoppingDialogOpen",2),Sa([pe()],Ra.prototype,"_webviewCard",2),Ra=Sa([Ji("mealie-recipe-dialog")],Ra);var Ta=Object.defineProperty,Da=Object.getOwnPropertyDescriptor,Ca=(e,t,i,a)=>{for(var s,n=a>1?void 0:a?Da(t,i):t,r=e.length-1;r>=0;r--)(s=e[r])&&(n=(a?s(t,i,n):s(n))||n);return a&&n&&Ta(t,i,n),n};let ja=class extends za{constructor(){super(...arguments),this.date=null,this._date="",this._entryType="dinner",this._title="",this._text="",this._handleAdd=()=>{this._date&&this._entryType&&this._title.trim()&&this.hass&&this.submit({run:()=>Mi(this.hass,{date:this._date,entryType:this._entryType,noteTitle:this._title.trim(),noteText:this._text.trim()||void 0,configEntryId:this.configEntryId??void 0}),success:"dialog.note_added_success",errorKey:"error.error_adding_recipe",signal:Ci})}}onOpen(){this._date=this.date??Ri(new Date),this._entryType="dinner",this._title="",this._text=""}render(){return this.open?B`
      <ha-dialog .open=${this.open} width="small" .hass=${this.hass} @closed=${this._close}>
    ...
    `:q}};Ca([ce()],ja.prototype,"date",2),Ca([pe()],ja.prototype,"_date",2),Ca([pe()],ja.prototype,"_entryType",2),Ca([pe()],ja.prototype,"_title",2),Ca([pe()],ja.prototype,"_text",2),ja=Ca([Ji("mealie-mealplan-note-dialog")],ja);var Pa=Object.defineProperty,Oa=Object.getOwnPropertyDescriptor,Na=(e,t,i,a)=>{for(var s,n=a>1?void 0:a?Oa(t,i):t,r=e.length-1;r>=0;r--)(s=e[r])&&(n=(a?s(t,i,n):s(n))||n);return a&&n&&Pa(t,i,n),n};let La=class extends za{constructor(){super(...arguments),this.targetDate="",this._date="",this._entryType="dinner",this._handleAdd=()=>{this._date&&this._entryType&&this.hass&&this.submit({run:()=>{return e=this.hass,t={date:this._date,entryType:this._entryType,configEntryId:this.configEntryId??void 0},bi("error.error_adding_recipe",()=>$i(e,"set_random_mealplan",{date:t.date,entry_type:t.entryType},t.configEntryId));var e,t},success:"dialog.recipe_added_success",errorKey:"error.error_adding_recipe",signal:Ci})}}onOpen(){this._date=this.targetDate||Ri(new Date),this._entryType="dinner"}render(){return this.open?B`
      <ha-dialog .open=${this.open} width="small" .hass=${this.hass} @closed=${this._close}>
    ...
    `}};Ba([ce({attribute:!1})],Fa.prototype,"planRecipe",2),Ba([pe()],Fa.prototype,"_date",2),Ba([pe()],Fa.prototype,"_entryType",2),Ba([pe()],Fa.prototype,"_title",2),Ba([pe()],Fa.prototype,"_text",2),Fa=Ba([Ji("mealie-mealplan-edit-dialog")],Fa);var qa=Object.defineProperty,Ha=Object.getOwnPropertyDescriptor,Wa=(e,t,i,a)=>{for(var s,n=a>1?void 0:a?Ha(t,i):t,r=e.length-1;r>=0;r--)(s=e[r])&&(n=(a?s(t,i,n):s(n))||n);return a&&n&&qa(t,i,n),n};let Ka=class extends za{constructor(){super(...arguments),this.entry=null,this._handleDelete=()=>{this.entry&&this.hass&&this.submit({run:()=>{return e=this.hass,t=this.entry.id,i=this.configEntryId??void 0,bi("error.error_deleting_mealplan",()=>$i(e,"delete_mealplan",{mealplan_id:t},i));var e,t,i},success:"dialog.mealplan_deleted_success",errorKey:"error.error_deleting_mealplan",signal:Ci})}}render(){return this.open&&this.entry?B`
      <ha-dialog .open=${this.open} width="small" .hass=${this.hass} @closed=${this._close}>
        ...
        <div class="dialog-body-recipe">
          <span class="dialog-type">${gi(this.entry.entryType,this.hass?.locale?.language)}</span>
          <span class="dialog-label">${Di(this.entry.date,this.hass)}</span>
        </div>
    ...
    `}_renderDayHeader(e){return B`
      <div class="card-header-row">
        <div class="date-label">${Di(e,this.hass)}</div>
    ...
    `}_renderRecipeCard(e){return B`
      <div class="recipe-card">
        <div class="recipe-card-body">
          <div class="recipe-type">${gi(e.entry_type,this.hass?.locale?.language)}</div>
  ...
  `}
      ...
      ${this.renderVersion()}
    `:this.renderEditorLoading();var e,t,i,a,s,n}};Ya=((e,t,i,a)=>{for(var s,n=a>1?void 0:a?Ja(t,i):t,r=e.length-1;r>=0;r--)(s=e[r])&&(n=s(n)||n);return n})([Ji("mealie-recipe-card-editor")],Ya);var Xa=Object.defineProperty,es=Object.getOwnPropertyDescriptor,ts=(e,t,i,a)=>{for(var s,n=a>1?void 0:a?es(t,i):t,r=e.length-1;r>=0;r--)(s=e[r])&&(n=(a?s(t,i,n):s(n))||n);return a&&n&&Xa(t,i,n),n};let is=class extends za{constructor(){super(...arguments),this.recipe=null,this._date="",this._entryType="dinner",this._imageMissing=!1,this._handleAdd=()=>{const e=this.recipe?.recipe_id;e&&this._date&&this._entryType&&this.hass&&this.submit({run:()=>Mi(this.hass,{date:this._date,entryType:this._entryType,recipeId:e,configEntryId:this.configEntryId??void 0}),success:"dialog.recipe_added_success",errorKey:"error.error_adding_recipe",signal:Ci})}}onOpen(){this._date=Ri(new Date),this._entryType="dinner",this._imageMissing=!1}_renderImage(){return!this.recipe||this._imageMissing?q:ra(this.hass,this.recipe,{url:this.effectiveUrl,variant:"original",containerClass:"detail-image",imgClass:"detail-image-img",onImageMissing:()=>{this._imageMissing=!0}})}render(){return this.recipe?B`
      <ha-dialog .open=${this.open} width="small" .hass=${this.hass} @closed=${this._close}>
        <span slot="headerTitle">${this.recipe.name}</span>
    ...
    `:q}};ts([ce({attribute:!1})],is.prototype,"recipe",2),ts([ce()],is.prototype,"effectiveUrl",2),ts([pe()],is.prototype,"_date",2),ts([pe()],is.prototype,"_entryType",2),ts([pe()],is.prototype,"_imageMissing",2),is=ts([Ji("mealie-mealplan-dialog")],is);var as=Object.defineProperty,ss=Object.getOwnPropertyDescriptor,ns=(e,t,i,a)=>{for(var s,n=a>1?void 0:a?ss(t,i):t,r=e.length-1;r>=0;r--)(s=e[r])&&(n=(a?s(t,i,n):s(n))||n);return a&&n&&as(t,i,n),n};let rs=class extends re{constructor(){super(...arguments),this.value="",this.placeholder=""}_emit(e){this.value=e,this.dispatchEvent(new CustomEvent("search-changed",{detail:{value:e},bubbles:!1,composed:!1}))}_onInput(e){this._emit(e.target.value)}_clear(){this._emit("")}render(){return customElements.get("ha-input-search")?this._renderInputSearch():this._renderTextfield()}_renderInputSearch(){return B` <ha-input-search appearance="outlined" .value=${this.value} .placeholder=${this.placeholder} @input=${this._onInput}></ha-input-search> `}_renderTextfield(){return B`
  ...
  `,ns([ce()],rs.prototype,"value",2),ns([ce()],rs.prototype,"placeholder",2),rs=ns([Ji("mealie-recipe-search")],rs);var os=Object.defineProperty,ls=Object.getOwnPropertyDescriptor,ds=(e,t,i,a)=>{for(var s,n=a>1?void 0:a?ls(t,i):t,r=e.length-1;r>=0;r--)(s=e[r])&&(n=(a?s(t,i,n):s(n))||n);return a&&n&&os(t,i,n),n};let cs=class extends za{constructor(){super(...arguments),this._url="",this._includeTags=!1,this._importedName=null,this._handleImport=()=>{this._url.trim()&&this.hass&&(this._importedName=null,this.submit({run:async()=>{const e=await(t=this.hass,i={url:this._url.trim(),includeTags:this._includeTags,configEntryId:this.configEntryId??void 0},bi("error.error_loading",async()=>xi(await zi(t,"import_recipe",{url:i.url,...i.includeTags&&{include_tags:!0}},i.configEntryId))));var t,i;this._importedName=e?.name??e?.slug??""},success:()=>`${this.localize("dialog.recipe_imported_success")}${this._importedName?`: ${this._importedName}`:""}`,errorKey:"error.error_loading",signal:ji,closeOnSuccess:!1}))}}onOpen(){this._url="",this._includeTags=!1,this._importedName=null}render(){return this.open?B`
    ...
    `}}hs([pe()],_s.prototype,"config"),hs([pe()],_s.prototype,"recipes"),hs([pe()],_s.prototype,"_mealplanRecipe"),hs([pe()],_s.prototype,"_dialogRecipe"),hs([pe()],_s.prototype,"_searchQuery"),hs([pe()],_s.prototype,"_importDialogOpen"),hs([pe()],_s.prototype,"_shoppingRecipe"),customElements.get("mealie-mealplan-card")||customElements.define("mealie-mealplan-card",Qa),customElements.get("mealie-recipe-card")||customElements.define("mealie-recipe-card",_s),window.customCards=window.customCards||[];[{type:"mealie-mealplan-card",name:`${li("en","cards.name_mealplan")}`,description:`${li("en","cards.description_mealplan")}`,configurable:!0,preview:!0,documentationURL:"https://github.com/domodom30/mealie-card"},{type:"mealie-recipe-card",name:`${li("en","cards.name_recipes")}`,description:`${li("en","cards.description_recipes")}`,configurable:!0,preview:!0,documentationURL:"https://github.com/domodom30/mealie-card"}].forEach(e=>{window.customCards?.some(t=>t.type===e.type)||window.customCards?.push(e)}),console.info(`%c MEALIE-CARD %c ${_a}`,"color: white; background: orange; font-weight: 700;","color: orange; background: white; font-weight: 700;");export{Qa as MealieMealplanCard,_s as MealieRecipeCard};
